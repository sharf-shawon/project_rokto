...
# project_rokto/
APPS_DIR = BASE_DIR / "project_rokto"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "project_rokto.contrib.sites.migrations"}
...
AUTHENTICATION_BACKENDS = [
    ...
    "project_rokto.users.backends.PhoneOTPBackend",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "project_rokto.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "project_rokto.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "project_rokto.users.forms.UserSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Project Rokto API",
    "DESCRIPTION": "Documentation of API endpoints of Project Rokto",
    "VERSION": "1.0.0",
...
# MIM SMS
# ------------------------------------------------------------------------------
MIMSMS_USERNAME = env("MIMSMS_USERNAME", default="")
MIMSMS_API_KEY = env("MIMSMS_API_KEY", default="")
MIMSMS_SENDER_ID = env("MIMSMS_SENDER_ID", default="")
MIMSMS_API_URL = env("MIMSMS_API_URL", default="https://esms.mimsms.com/smsapi")
